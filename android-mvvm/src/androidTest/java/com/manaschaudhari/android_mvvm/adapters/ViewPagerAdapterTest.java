...
public class ViewPagerAdapterTest {
    ...
    private ObservableList<ViewModel> viewModelsSource;
    ...
    private ObservableList.OnListChangedCallback connection;
    
    @Before
    public void setUp() throws Exception {
        viewModelsSource = new ObservableArrayList<>();
        viewModelsSource.addAll(TestViewModel.dummyViewModels(INITIAL_COUNT));
        testViewProvider = new TestViewProvider();
        testBinder = new TestViewModelBinder();
        subscriptionCounter = new SubscriptionCounter<>();
        sut = new TestViewPagerAdapter(viewModelsSource,
    ...
    public void itemCountOnUpdate() throws Exception {
        viewModelsSource.clear();
        viewModelsSource.addAll(TestViewModel.dummyViewModels(4));
    ...
    public void noSubscriptionsInitially() throws Exception {
        ...
        ObservableList<ViewModel> source = viewModelsSource;
    ...
    public void instantiateItemAddsBindedView() throws Exception {
        ...
        assertTrue(testBinder.lastViewModel == viewModelsSource.get(0));
    }
    ...
    private static class TestViewPagerAdapter extends ViewPagerAdapter {
        ...
        public TestViewPagerAdapter(ObservableList<ViewModel> viewModels, ViewProvider viewProvider, ViewModelBinder binder) {
